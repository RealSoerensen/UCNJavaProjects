...
public class TestCalculationCurrencyEuro {
	 ...
	 */
	@Test
	public void shouldDisplay2MinFor5Cents() throws IllegalCoinException, DatabaseLayerException {
		// Arrange
		...
		// Assert
		assertEquals(expectedParkingTime, ps.readDisplay(), "Should display 2min for 5 cents");
